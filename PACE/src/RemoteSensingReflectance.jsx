...
const RemoteSensingReflectance = () => {
  ...
  useEffect(() => {
    ...
    L.tileLayer(`https://oceancolor.gsfc.nasa.gov/showimages/PACE_OCI/IMAGES/RRS/L3/2024/0711/PACE_OCI.20240711_20240718.L3m.8D.RRS.V2_0.Rrs.0p1deg.NRT.nc.png`, {
  ...
  return (
    <div>
      ...
      <div className="container-fluid map-section text-center py-5">
        ...
        <h3 className='text-white mb-4'>Remote Sensing Reflectance</h3>
        <div
          ref={mapContainer}
...
export default RemoteSensingReflectance;
